...
import com.example.cube.Notice.NoticeAdapter;
...
public class BoardAdapter extends RecyclerView.Adapter<BoardAdapter.ItemViewHolder> {
    ...
    private ArrayList<NoticeData> BoardList;
    public BoardAdapter(ArrayList<NoticeData> BoardList) {
        this.BoardList = BoardList;
    }
    @NotNull
    @Override
    public BoardAdapter.ItemViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NotNull ItemViewHolder holder, int position) {
        ...
        NoticeData data = BoardList.get(position);
